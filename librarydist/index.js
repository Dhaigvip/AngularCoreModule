import { Component, Directive, ElementRef, ErrorHandler, EventEmitter, HostListener, Inject, Injectable, Input, LOCALE_ID, NgModule, NgZone, Output, Pipe, Renderer, ViewChild, ViewEncapsulation } from '@angular/core';
import { CommonModule, Location } from '@angular/common';
import { ControlContainer, FormControl, FormsModule, NG_VALIDATORS, NgForm, ReactiveFormsModule } from '@angular/forms';
import { Headers, Http, HttpModule, RequestOptions, ResponseContentType, URLSearchParams } from '@angular/http';
import { HttpClient, HttpClientModule, HttpHeaders, HttpParams } from '@angular/common/http';
import { ActivatedRoute, NavigationEnd, ROUTER_CONFIGURATION, Router, RouterModule } from '@angular/router';
import { ChartsModule } from 'ng2-charts';
import { ErrorStateMatcher, MAT_DIALOG_DATA, MAT_TOOLTIP_DEFAULT_OPTIONS, MatAutocompleteModule, MatButtonModule, MatButtonToggleModule, MatCardModule, MatCheckboxModule, MatChipsModule, MatDatepickerModule, MatDialog, MatDialogModule, MatDialogRef, MatExpansionModule, MatGridListModule, MatIconModule, MatInputModule, MatListModule, MatMenuModule, MatNativeDateModule, MatPaginatorModule, MatProgressBarModule, MatProgressSpinnerModule, MatRadioModule, MatRippleModule, MatSelectModule, MatSidenavModule, MatSlideToggleModule, MatSliderModule, MatSnackBar, MatSnackBarModule, MatSortModule, MatStepperModule, MatTableModule, MatTabsModule, MatToolbarModule, MatTooltipModule, ShowOnDirtyErrorStateMatcher } from '@angular/material';
import { Store, StoreModule, createFeatureSelector, createSelector, select } from '@ngrx/store';
...
import { Observable as Observable$2, Subject } from 'rxjs/Rx';
import 'rxjs/add/operator/map';
import { saveAs } from 'file-saver';
import { SignalR, SignalRConfiguration, SignalRModule } from '@dharapvj/ngx-signalr';
 ...
 * @suppress {checkTypes} checked by tsc
 */
var getCoreState = createFeatureSelector('core');
var getInboxItems = createSelector(getCoreState, function (state) { return state.TCMMessages; });
var getSelectedInboxItem = createSelector(getCoreState, function (state) { return state.CurrentInboxItem; });
var getDashboardItems = createSelector(getCoreState, function (state) { return state.DashboardMessages; });
...
var LoaderService = /** @class */ (function () {
    function LoaderService() {
        var _this = this;
        this.status = new BehaviorSubject$1(false);
...
var ThemeService = /** @class */ (function () {
    function ThemeService(configService, zone) {
        ...
        this.zone = zone;
        this.theme = new BehaviorSubject$1("");
        this._theme = 'primary';
        this.init = function () {
...
var DataService = /** @class */ (function () {
    function DataService(http$$1, loaderService, coreConfig, logger, _cache) {
        ...
        this.HandleExceptions = function (error, origin) {
            ...
            return Observable$2.of(tcmResponse);
        };
        /**
        ...
        this.ExportToExcel = function (domain, request, showLoadIndicator) {
            ...
            _this.http.post(url, request, options)
                ...
                saveAs(file, request.Data.ExportName + "-" + dateSuffix + '.xlsx');
            }, function (error) {
                return _this.HandleExceptions(error, url);
            });
        };
...
var MessageService = /** @class */ (function () {
    ...
    function (message, target, messageId) {
        ...
        var /** @type {?} */ r = this.conx.start().then(function (c) {
            return Observable$2.fromPromise(c.invoke('ReceiveClientMessage', m));
        });
        return r;
    };
...
var UserSettingsService = /** @class */ (function () {
    function UserSettingsService(logger, dataService, zone, winRef, coreConfig) {
        ...
        this.zone.runOutsideAngular(function () {
            //Evevry second
            timer$1(10000, 10000).subscribe(function (val) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.configService.Init().subscribe(function (config) {
                    ...
                    _this.auth.Autheticate().subscribe(function (data) {
                        ...
                        forkJoin$1(subscribersArray).subscribe(function (result) {
...
var ModuleBaseComponent = /** @class */ (function () {
    function ModuleBaseComponent(pageId, moduleName, ServiceLocator) {
        ...
        this.ticker = Observable$2.interval(20000)
...
var DashboardServiceCore = /** @class */ (function () {
    function DashboardServiceCore(store$$1, coreConfig) {
        ...
        this.Init = function (hubName, userContext, options) {
            _this._hubConnection = new HubConnectionBuilder()
    ...
    function AuthServiceCore(window, dataService) {
        ...
        this.AutheticateInternal = function (path) {
            ...
            if (_this.GetExpiryDate() > d) {
                ...
                return Observable$2.of(context);
            }
            var /** @type {?} */ request = new ClientRequestDTO();
            request.MetaData.Action = "Autheticate";
...
var DataServiceCore = /** @class */ (function () {
    function DataServiceCore(http$$1, loaderService, coreConfig, logger, _cache) {
        ...
        this.handleAPIError = function (error) {
            ...
            return Observable$2.of(error.error);
        };
        this.handleError = function (error) {
            ...
            return Observable$2.of(errorResponse);
        };
